            ...
            <table id="dataTable" class="table table-bordered" cellspacing="1"><br/>
                ...
                <tbody>
                    ...
                    <tr align="center">
                        ...
                        <td>
                            <a href="{{ route('barang.edit', $barangItem->id) }}" class="btn btn-sm btn-warning">
                                <i class="fas fa-edit"></i> Edit
                            </a>
                            <!-- Tombol Hapus -->
                            <button type="button" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#confirmDeleteModal{{ $barangItem->id }}">
                    ...
                    <div class="modal fade" id="confirmDeleteModal{{ $barangItem->id }}" tabindex="-1" role="dialog" aria-labelledby="confirmDeleteModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <form method="post" action="{{ route('barang.destroy', $barangItem->id) }}">
                                    @csrf
                                    @method('delete')
