                ...
                <tbody>
                    ...
                    <tr align="center">
                        ...
                        <td>
                            ...
                            <!-- Tombol Hapus -->
                            <button type="button" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#confirmDeleteModal{{ $obatItem->id }}">
                    ...
                    <div class="modal fade" id="confirmDeleteModal{{ $obatItem->id }}" tabindex="-1" role="dialog" aria-labelledby="confirmDeleteModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <form method="post" action="{{ route('obat.destroy', $obatItem->id) }}">
                                    @csrf
                                    @method('delete')
