            ...
            <table id="dataTable" class="table table-bordered" cellspacing="1"><br/>
                ...
                <tbody>
                    ...
                    <tr align="center">
                        ...
                        <td>
                            <a href="{{ route('pasien.edit', $pasienItem->id) }}" class="btn btn-sm btn-warning">
                                <i class="fas fa-edit"></i> Edit
                            </a>
                            <!-- Tombol Hapus -->
                            <button type="button" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#confirmDeleteModal{{ $pasienItem->id }}">
                    ...
                    <div class="modal fade" id="confirmDeleteModal{{ $pasienItem->id }}" tabindex="-1" role="dialog" aria-labelledby="confirmDeleteModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <form method="post" action="{{ route('pasien.destroy', $pasienItem->id) }}">
                                    @csrf
                                    @method('delete')
